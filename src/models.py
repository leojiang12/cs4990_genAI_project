...
class UNetGenerator(nn.Module):
    def __init__(self, in_ch=3, out_ch=3, features=64):
        ...
        self.down1 = nn.Sequential(nn.Conv2d(in_ch, features, 4, 2, 1), nn.LeakyReLU(0.2))
        ...
        # Decoder: upsampling
        self.up1   = nn.Sequential(nn.ConvTranspose2d(features*2, features, 4, 2, 1), nn.BatchNorm2d(features), nn.ReLU())
        # Final output
